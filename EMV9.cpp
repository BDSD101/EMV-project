...
public:
    ...
    /**
     * @brief  Returns true if at least one payment completed successfully.
     *         Used to gate display of sensitive output (e.g. RSA keys).
     */
    bool hasSuccessfulTransaction() const
    {
...
int main()
{
    try {
        ...
        // ================================================================
        //  Bank RSA keys — only printed when a payment succeeded.
        //  Declined / aborted transactions suppress the key display.
        // ================================================================
        if (terminal.hasSuccessfulTransaction()) {
